      ...
      <div className="mx-auto w-full max-w-7xl px-4 pb-[calc(6rem+env(safe-area-inset-bottom))] pt-5 md:px-5 md:py-7">
        ...
        {view === "settings" && (
          <SettingsView
            ...
            onBudgetImportClick={() => budgetImportInputRef.current?.click()}
            ...
            onTransactionExport={() =>
              downloadBackupFile("transactions", transactions, categories)
            }
    ...
    <>
      {items.map((item) => (
        <Button
          ...
          key={item.view}
          type="button"
          variant={currentNavView === item.view ? "default" : "secondary"}
          size="sm"
